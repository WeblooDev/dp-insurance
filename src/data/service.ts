    ...
    return [

      {
        ...
        heroSection: { 
          ...
          faqSection: { 
            ...
            faqs: [
              { question: "What is duPont REGISTRY insurance?", answer: "duPont REGISTRY is an insurance broker. It operates as a distributor of insurance options designed specifically to cover luxury and exotic . Select from multiple plan options by top insurance companies the highest-rated coverage provider for exotic antique/classic cars." },
              ...
              { question: "Do expensive cars require an appraisal to confirm their value?", answer: ` <p >Typically, appraisals are not required. We will contact you during the underwriting process if we need further documentation supporting a vehicle's value, but this is uncommon.</p>
                <br/>
...

      {
        ...
        faqSection: { 
            ...
            description: "Considering duPont REGISTRY Insurance? Here’s what you need to know about us before you sign up for a policy.",
            faqs: [
              { question: "What is duPont REGISTRY insurance?", answer: "duPont REGISTRY is an insurance broker. It operates as a distributor of insurance options designed specifically to cover luxury and exotic antique/classic cars, jewelry, real estate, aviation, marine and personal goods. Select from multiple plan options by top insurance companies, recognized as the highest-rated providers for exotic car coverage." },
          ...
          splitSections: [
            {
              imageUrl: "/rightr.png",
              content: [
                { title: "Risk Management Advice", description: "Risk Management Advice provides complimentary home appraisals to ensure your home and valuables are fully protected, while also offering expert guidance on security, home protection, fire prevention, and catastrophe preparedness." },
      ...
      
      {
        ...
        splitSections: [ 
          ...
          faqSection: { 
            ...
            faqs: [
              { question: "What is duPont REGISTRY insurance?", answer: "duPont REGISTRY is an insurance broker. It operates as a distributor of insurance options designed specifically to cover luxury and exotic antique/classic cars, jewelry, real estate, aviation, marine and personal goods. Select from multiple plan options by top insurance companies, recognized as the highest-rated providers for exotic car coverage." },
              { question: "What types of wine & spirits and high-value fashion items can be insured?", 
                answer: `
            ...
            `, },
              { question: "How is the value of my wine & spirits collection determined?", answer: "The insured value is typically based on purchase price, appraisal, or current market value. For rare and vintage pieces, we work with industry experts to assess their worth. " },
              { question: " Does insurance cover damage, theft, or loss while traveling?", answer: "Yes, many wine & spirits insurance policies offer worldwide coverage, protecting your collection whether it's at home, in storage, or while traveling. " },
            ],
          },
