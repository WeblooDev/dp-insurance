...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-white flex flex-col gap-10">
      ...
      <LineCall title="Need Premium Insurance for Unique Needs?" />
        ...
        services={[
          {
            ...
            description:
              "Tailored insurance for luxury cars, jewelry, real estate, aviation, and yachts & watercraft-designed to fit your lifestyle.",
          },
          {
            image: "/why2.png",
            name: "White Glove Service",
            description:
              "Seamless, discreet coverage with concierge support, from policy setup to claims assistance.",
          },
          {
            image: "/why3.png",
            name: "Competitive Rates ",
            description:
              "Elite protection at competitive rates, ensuring the best value for your prized possessions.",
          },
        ]}
      />
      ...
      <SplitSection
        ...
        content={[
          {
            title: "Bespoke Policies",
            description:
              "Every asset is unique, and your insurance should reflect that. Our custom policies offer meticulous coverage tailored to your luxury lifestyle.",
          },
          {
            title: "Claims Advocacy",
            description:
              "When the unexpected happens, We are committed to finding the best solution for you. Our claims process ensures fast and hassle-free resolutions.",
          },
          {
            title: "Global Coverage",
            description:
              "Your assets are protected, wherever life takes you. We offer worldwide insurance solutions for ultimate peace of mind.",
          },
        ]}
      />
